...
And leveraging Rust and concurrent programming, you won't have to wait ages until the gosh-darned thing is compressed and uploaded to Google Drive! Yay two. 
